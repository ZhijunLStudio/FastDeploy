...
def lightning_attention(
    ...
    """
    FastDeploy/PaddlePaddle wrapper for the vLLM lightning_attention prefill logic.
    """
    q = q.contiguous()
    k = k.contiguous()
    v = v.contiguous()
    ...
    array = paddle.arange(0, BLOCK, dtype='float32').to(q.place) + 1
    ...
    _fwd_none_diag_kernel[grid_none_diag](
        q, o, slope_rate, kv_intermediate,
        b=B, h=H, n=N, d=D, e=E,
        BLOCK=BLOCK, NUM_BLOCK=NUM_BLOCK,
        E_FBLOCK=E_FBLOCK, CBLOCK=CBLOCK_diag, NUM_CBLOCK=NUM_CBLOCK_diag
    )
    # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
def linear_decode_forward_triton(
    ...
    """
    FastDeploy/PaddlePaddle wrapper for the vLLM linear_decode_forward_triton logic.
    """
    B, H, _, D = q.shape
    ...
    _linear_attn_decode_kernel[grid](
        q, k, v, kv_caches, slope_rate, slot_idx, output,
        D=D,
