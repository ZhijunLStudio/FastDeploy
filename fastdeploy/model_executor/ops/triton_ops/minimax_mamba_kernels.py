# fastdeploy/model_executor/ops/triton_ops/minimax_mamba_kernels.py
"""
Contains the raw Triton kernel definitions for MiniMax-M1's Linear Attention,
wrapped with FastDeploy's JIT compilation utility.
This file is a direct port of vLLM's lightning_attn.py kernels.
"""
import triton
